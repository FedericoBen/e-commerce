...
type ValidTypes = "shirts" | "pants" | "hoodies" | "hats" | "not-specified";
...
export const initialData: SeedData = {
  ...
  categories: ["shirts", "pants", "hoodies", "hats", "not-specified"],
  products: [
    {
      description:
    ...
    {
      description:
        "Designed for fit, comfort and style, the kid Cybertruck Graffiti Long Sleeve Tee features a water-based Cybertruck graffiti wordmark across the chest, a Tesla wordmark down the left arm and our signature T logo on the back collar. Made from 50% cotton and 50% polyester.",
      images: ["1742694-00-A_1_2000.jpg", "1742694-00-A_3.jpg"],
      inStock: 10,
      price: 30,
      sizes: ["XS", "S", "M"],
      slug: "kid_cybertruck_long_sleeve_tee",
      type: "shirts",
      tags: ["shirt"],
      title: "kid Cybertruck Long Sleeve Tee",
      gender: "kid",
    },
    {
      description:
        "The kid Scribble T Logo Tee is made from 100% Peruvian cotton and features a Tesla T sketched logo for every young artist to wear.",
      images: ["8529312-00-A_0_2000.jpg", "8529312-00-A_1.jpg"],
      inStock: 0,
      price: 25,
      sizes: ["XS", "S", "M"],
      slug: "kid_scribble_t_logo_tee",
      type: "shirts",
      tags: ["shirt"],
      title: "kid Scribble T Logo Tee",
      gender: "kid",
    },
    {
      description:
        "The kid Cybertruck Tee features the iconic Cybertruck graffiti wordmark and is made from 100% Peruvian cotton for maximum comfort.",
      images: ["8529342-00-A_0_2000.jpg", "8529342-00-A_1.jpg"],
      inStock: 10,
      price: 25,
      sizes: ["XS", "S", "M"],
      slug: "kid_cybertruck_tee",
      type: "shirts",
      tags: ["shirt"],
      title: "kid Cybertruck Tee",
      gender: "kid",
    },
    {
      description:
        "The refreshed kid Racing Stripe Tee is made from 100% Peruvian cotton, featuring a newly enhanced racing stripe with a brushed Tesla wordmark that's perfect for any speed racer.",
      images: ["8529354-00-A_0_2000.jpg", "8529354-00-A_1.jpg"],
      inStock: 10,
      price: 30,
      sizes: ["XS", "S", "M"],
      slug: "kid_racing_stripe_tee",
      type: "shirts",
      tags: ["shirt"],
      title: "kid Racing Stripe Tee",
      gender: "kid",
    },
    {
      description:
      ...
      price: 30,
      sizes: ["XS", "S", "M"],
      slug: "kid_3d_t_logo_tee",
      type: "shirts",
      tags: ["shirt"],
      title: "kid 3D T Logo Tee",
      gender: "kid",
    },
    {
      description:
      ...
      price: 30,
      sizes: ["XS", "S", "M"],
      slug: "kid_checkered_tee",
      type: "shirts",
      tags: ["shirt"],
      title: "kid Checkered Tee",
      gender: "kid",
    },
    {
      description:
    ...
    {
      description:
        "The kid Scribble T Logo Onesie is made from 100% Peruvian cotton and features a Tesla T sketched logo for every little artist to wear.",
    ...
    {
      description:
        "Wear your kid Cyberquad Bomber Jacket during your adventures on Cyberquad for kid. The bomber jacket features a graffiti-style illustration of our Cyberquad silhouette and wordmark. With three zippered pockets and our signature T logo and Tesla wordmark printed along the sleeves, kid Cyberquad Bomber Jacket is perfect for wherever the trail takes you. Made from 60% cotton and 40% polyester.",
      images: ["1742702-00-A_0_2000.jpg", "1742702-00-A_1.jpg"],
      inStock: 10,
      price: 65,
      sizes: ["XS", "S", "M"],
      slug: "kid_cyberquad_bomber_jacket",
      type: "shirts",
      tags: ["shirt"],
      title: "kid Cyberquad Bomber Jacket",
      gender: "kid",
    },
    {
      description:
        "Cruise the playground in style with the kid Corp Jacket. Modeled after the original Tesla Corp Jacket, the kid Corp Jacket features the same understated style and high-quality materials but at a pint-sized scale.",
      images: ["1506211-00-A_0_2000.jpg", "1506211-00-A_1_2000.jpg"],
      inStock: 10,
      price: 30,
      sizes: ["XS", "S", "M"],
      slug: "kid_corp_jacket",
      type: "shirts",
      tags: ["shirt"],
      title: "kid Corp Jacket",
      gender: "kid",
    },
  ],
};
